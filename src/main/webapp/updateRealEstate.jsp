        ...
        <body>
            <nav class="navbar navbar-expand-lg navbar-dark navbar-custom ">
                <div class="container-fluid">
                    ...
                    <div class=" navbar-collapse justify-content-end grid gap-3 ">
                        ...
                        <input value="${inforef.getFirstName()}" class="btn btn-secondary dropdown-toggle mr-2" type="button"
            ...
            <div class="container mt-4">
                ...
                <form id="myForm" onsubmit="return registerUser()" action="updateInfoById" method="post"
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                value="${inforef.getEmail()}" />
                            <span class="error" id="emailError"></span>
                        </div>
                        <div class="col-md-6">
                            <label for="alternativeEmail" class="form-label">Alternative Email <span
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="panCardNumber" class="form-label">PAN Card Number<span
                                    class="error">*</span></label>
