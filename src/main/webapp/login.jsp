        ...
        <body>
                        ...
                        <div class="center-align border border-black shadow-lg p-3 mb-5 bg-body-tertiary rounded ">
                            ...
                            <form action="generateOTP" method="post" id="generatedOTPForm">
                                <div class="mb-3">
                                    ...
                                    <br>
                                    <input type="email" name="email" class="form-control" id="emailID" onchange="getEmailForLogin()" />

                                    <span class="error">${msg}</span>
                                    <span class="error" id="emailerror"></span>
                                </div>
                                <br>
                                <button type="submit" class="btn btn-primary mb-3" id="submitButton" disabled> generateOTP</button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <script>
                ...
                function getEmailForLogin() {
                    ...
                    request.open(
                        "GET",
                        "http://localhost:8080/realestate-management//getEmailForLogin/"+email
                    );
                    request.send();
